...
export function SignInScreen() {
  const { signInWithEmail, signInWithGoogle, signInWithApple, error, isLoading } = useAuth()
  ...
  async function handleEmailSignIn(e: React.FormEvent) {
    ...
    } catch { /* error shown from authStore */ }
  }
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleEmailSignIn} className="flex flex-col gap-3">
        ...
        <div className="relative">
          ...
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-content-secondary hover:text-content-primary"
          >
      ...
      <div className="flex flex-col items-center gap-2 text-center">
        <Link href="/auth/reset" className="text-sm text-primary-ink font-medium hover:underline">
          Forgot password?
        </Link>
        <p className="text-sm text-content-secondary">
          No account?{' '}
          <Link href="/auth/signup" className="text-primary-ink font-medium hover:underline">
            Sign up free
          </Link>
        </p>
        <Link href="/" className="text-xs text-content-muted hover:text-content-secondary mt-1">
