              ...
              >
                ...
                {!p.nextAction && (
                  <div className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest
                                  text-yellow-500 mb-3 bg-yellow-500/10 w-fit px-2.5 py-1 rounded-lg border border-yellow-500/20">
                ...
                {p.outcome && p.outcome !== p.name && (
                  <p className="text-sm font-medium text-slate-400 mb-2 italic leading-snug">{p.outcome}</p>
                )}
